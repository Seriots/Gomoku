...
void Game::init_sequenceDna() {
    ...
    _sequenceDna[SDNA_NNMMY] = minusFactor * valuesDna[VDNA_CAPTURE];
    ...
    _sequenceDna[SDNA_NMMYN] = minusFactor * valuesDna[VDNA_CAPTURE];
    _sequenceDna[SDNA_NMMYM] = minusFactor * valuesDna[VDNA_CAPTURE];
    _sequenceDna[SDNA_NMMYY] = minusFactor * valuesDna[VDNA_CAPTURE];
    ...
    _sequenceDna[SDNA_NYMMN] = minusFactor * valuesDna[VDNA_CAPTURE];
    ...
    _sequenceDna[SDNA_MNMMY] = minusFactor * valuesDna[VDNA_CAPTURE];
    ...
    _sequenceDna[SDNA_MYMMN] = minusFactor * valuesDna[VDNA_CAPTURE];
    ...
    _sequenceDna[SDNA_YNMMY] = minusFactor * valuesDna[VDNA_CAPTURE];
    ...
    _sequenceDna[SDNA_YMMNN] = minusFactor * valuesDna[VDNA_CAPTURE];
    _sequenceDna[SDNA_YMMNM] = minusFactor * valuesDna[VDNA_CAPTURE];
    _sequenceDna[SDNA_YMMNY] = minusFactor * valuesDna[VDNA_CAPTURE];
    ...
    _sequenceDna[SDNA_YYMMN] = minusFactor * valuesDna[VDNA_CAPTURE];
